  ...
  <body id="page-top">
    ...
    <div class="container">
            ...
            <hr class="star-light">
                <div class="container">
                    <?php
                        ...
                        if(!$total_registros == 0){
                            ...
                            $consultaLimitada = "SELECT * FROM usuario WHERE tipo_usuario = 'Alumno' LIMIT ".$inicio.",".$regPorPagina;
                            ...
                            echo "No hay alumnos ingresados aún.";
                        }
                ...
                if(!$total_registros == 0){
                    if($cantDePag == 1){
                        echo "Estos son todos los alumnos ingresados al momento.";
                    }
                    else{
                        for($i=1;$i<=$cantDePag;$i++){
                            if($i == $pagina){
                                ...
                                ?><li class="page-item"><a class="page-link" href="listadoAlumnos.php?<?php echo "pagina=".$i ?>">Página <?php echo $i ?></a></li>
                                <?php
                            }
                        }
                    }
